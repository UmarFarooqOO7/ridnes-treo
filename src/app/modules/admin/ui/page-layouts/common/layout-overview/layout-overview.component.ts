        ...
        <div class="w-full max-w-320 mx-auto px-6 md:px-8">
            <div class="py-8">
                        ...
                        <mat-button-toggle-group
                            ...
                            <mat-button-toggle
                                *ngFor="let option of overview.availableOptions"
                                ...
                                [ngClass]="{'bg-primary-100 text-primary-700 dark:bg-gray-700 dark:text-gray-50': option.value === overview.selectedOption}"
                                [value]="option.value"
                                disableRipple>
                                {{option.title}}
                            </mat-button-toggle>
                ...
                <ng-container *ngIf="overview.options[overview.selectedOption] as selectedOption">
                    <div>
                        <!-- Preview -->
                        <div class="mt-10 h-192 ring-1 ring-gray-300 shadow-xl rounded-lg overflow-auto dark:ring-gray-700">
                            <div class="flex flex-auto min-h-full">
                                ...
                                <div class="flex flex-col flex-auto">
                                    <!-- Header -->
                                    <div class="flex items-center justify-end h-16 px-6 sm:px-10 border-b border-gray-300 bg-gray-200 z-10 dark:border-gray-700 dark:bg-gray-800">
                                    ...
                                    <!-- Footer -->
                                    <div class="flex items-center h-14 px-6 sm:px-10 border-t border-gray-300 bg-gray-200 z-10 dark:border-gray-700 dark:bg-gray-800">
